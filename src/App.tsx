...
import { BarChart, Users, PiggyBank, Plus, TrendingUp, Notebook } from 'lucide-react';

function App() {
  const currentUser = useAppStore(state => state.currentUser);
  const [isAddExpenseModalOpen, setIsAddExpenseModalOpen] = useState(false);
  const [activeTab, setActiveTab] = useState<'dashboard' | 'management' | 'cagnottes' | 'analysis' | 'notepad'>('dashboard');
